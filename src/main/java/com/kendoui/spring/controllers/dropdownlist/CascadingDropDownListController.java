...
public class CascadingDropDownListController {
    ...
    public
    @ResponseBody
    DataSourceResult categories(@RequestBody DataSourceRequest request) {
    ...
    public
    @ResponseBody
    DataSourceResult products(@RequestBody DataSourceRequest request) {
    ...
    public
    @ResponseBody
    List<?> orders(@RequestBody DataSourceRequest request) {
