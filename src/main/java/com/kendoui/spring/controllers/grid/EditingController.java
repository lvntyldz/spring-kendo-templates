...
public class EditingController {
    ...
    public
    @ResponseBody
    List<Product> update(@RequestBody ArrayList<Map<String, Object>> models) {
    ...
    public
    @ResponseBody
    List<Product> create(@RequestBody ArrayList<Map<String, Object>> models) {
        List<Product> products = new ArrayList<Product>();
    ...
    public
    @ResponseBody
    List<Product> destroy(@RequestBody ArrayList<Map<String, Object>> models) {
        List<Product> products = new ArrayList<Product>();
