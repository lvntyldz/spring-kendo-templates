...
public class NavigationController {
    ...
    public
    @ResponseBody
    Product update(@RequestBody Map<String, Object> model) {
    ...
    public
    @ResponseBody
    Map<String, Object> create(@RequestBody Map<String, Object> model) {
    ...
    public
    @ResponseBody
    Product destroy(@RequestBody Map<String, Object> model) {
        Product target = new Product();
