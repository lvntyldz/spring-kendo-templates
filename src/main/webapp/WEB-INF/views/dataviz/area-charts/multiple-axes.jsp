...
<div id="example" class="k-content">
    <div class="chart-wrapper">
        ...
        <kendo:chart name="chart">
            ...
            <kendo:chart-series>
                <kendo:chart-seriesItem type="column" stack="true" color="#13558E"
                                        data="<%= new int[] { 20, 40, 45, 30, 50 } %>" name="on battery"/>
                <kendo:chart-seriesItem type="column" stack="true" color="#E21219"
                                        data="<%= new int[] { 20, 30, 35, 35, 40 } %>" name="on gas"/>
                <kendo:chart-seriesItem type="area" color="#DE7E42" data="<%= new int[] { 30, 38, 40, 32, 42 } %>"
                                        name="MPG" axis="mpg"/>
                <kendo:chart-seriesItem type="area" color="#057589"
                                        data="<%= new double[] { 7.8, 6.2, 5.9, 7.4, 5.6 } %>" name="l/100 km"
                                        axis="l100km"/>
            </kendo:chart-series>
            ...
            <kendo:chart-categoryAxis>
                <kendo:chart-categoryAxisItem axisCrossingValue="<%= new int[] { 0, 0, 10, 10 } %>"
