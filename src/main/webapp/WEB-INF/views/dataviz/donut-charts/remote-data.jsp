...
<div id="example" class="k-content">
    <div class="chart-wrapper">
        <kendo:chart name="chart" class="combined-donuts">
            ...
            <kendo:chart-series>
                <kendo:chart-seriesItem type="donut" field="share" categoryField="resolution"
                                        visibleInLegendField="visibleInLegend" padding="10"/>
            </kendo:chart-series>
        ...
        <div class="single-donuts">
            <kendo:chart name="chart2006" class="donut">
                ...
                <kendo:chart-series>
                    <kendo:chart-seriesItem type="donut" field="share" categoryField="resolution"
                                            visibleInLegendField="visibleInLegend" padding="0"/>
                </kendo:chart-series>
                <kendo:chart-tooltip visible="true" template="#= dataItem.Resolution #: #= value #%"/>
            </kendo:chart>
