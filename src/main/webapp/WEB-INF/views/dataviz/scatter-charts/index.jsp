    ...
    <div class="chart-wrapper">
        <kendo:chart name="chart">
            ...
            <kendo:chart-series>
                ...
                <kendo:chart-seriesItem type="scatter" data="<%= new int[][] { { 1000, 137 } } %>"
                                        name="Pentium XE 965">
                    <kendo:chart-seriesItem-labels template="#= series.name #" position="left" visible="true"/>
                </kendo:chart-seriesItem>
                <kendo:chart-seriesItem type="scatter" data="<%= new int[][] { { 170, 125 } } %>"
                                        name="Athlon 64 X2 4200+">
                    <kendo:chart-seriesItem-labels template="#= series.name #" position="right" visible="true"/>
                </kendo:chart-seriesItem>
                <kendo:chart-seriesItem type="scatter" data="<%= new int[][] { { 205, 138 } } %>"
                                        name="Athlon 64 X2 4600+">
                    <kendo:chart-seriesItem-labels template="#= series.name #" position="right" visible="true"/>
                </kendo:chart-seriesItem>
                <kendo:chart-seriesItem type="scatter" data="<%= new int[][] { { 800, 147 } } %>"
                                        name="Athlon 64 FX-62">
                    <kendo:chart-seriesItem-labels template="#= series.name #" position="right" visible="true"/>
                </kendo:chart-seriesItem>
                <kendo:chart-seriesItem type="scatter" data="<%= new int[][] { { 170, 130 } } %>"
                                        name="Core 2 Duo E6400">
                    <kendo:chart-seriesItem-labels template="#= series.name #" position="right" visible="true"/>
                </kendo:chart-seriesItem>
                <kendo:chart-seriesItem type="scatter" data="<%= new int[][] { { 305, 163 } } %>"
                                        name="Core 2 Duo E6600">
                    <kendo:chart-seriesItem-labels template="#= series.name #" position="right" visible="true"/>
                </kendo:chart-seriesItem>
                <kendo:chart-seriesItem type="scatter" data="<%= new int[][] { { 530, 177 } } %>"
                                        name="Core 2 Duo E6700">
                    <kendo:chart-seriesItem-labels template="#= series.name #" position="right" visible="true"/>
                </kendo:chart-seriesItem>
                <kendo:chart-seriesItem type="scatter" data="<%= new int[][] { { 1000, 190 } } %>"
