...
<div id="page">
    ...
    <ul id="suites">
        <li class="box">
            <a href="<c:url value='/web/'/>" class="imgPlate"><img
                    src="<c:url value='/resources/shared/styles/demos-web.png'/>"/></a>

            <h2><a href="<c:url value='/web/'/>">Web examples</a></h2>
        </li>
        <li class="box">
            <a href="<c:url value='/dataviz/'/>" class="imgPlate"><img
                    src="<c:url value='/resources/shared/styles/demos-dataviz.png'/>"/></a>
