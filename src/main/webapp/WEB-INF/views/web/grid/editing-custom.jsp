...
<kendo:grid name="grid" pageable="true" sortable="true" scrollable="true" editable="true">
    ...
    <kendo:grid-columns>
        ...
        <kendo:grid-column title="Category" field="category" editor="categoryDropDownEditor"
    ...
    <kendo:dataSource pageSize="10" batch="true">
        <kendo:dataSource-transport>
            ...
            <kendo:dataSource-transport-update url="${updateUrl}" dataType="json" type="POST"
                                               contentType="application/json"/>
            <kendo:dataSource-transport-destroy url="${destroyUrl}" dataType="json" type="POST"
                                                contentType="application/json"/>
        </kendo:dataSource-transport>
