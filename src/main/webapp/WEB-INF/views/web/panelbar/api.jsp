...
<div class="configuration k-widget k-header">
    ...
    <ul class="options">
        <li>
            <input type="text" value="0" id="selectIndex" class="k-textbox"/>
            <button class="selectItem k-button">Select</button>
        </li>
        <li>
        ...
        <li>
            <input type="text" value="Item" id="beforeText" class="k-textbox"/>
            <button class="beforeItem k-button">Insert Before</button>
        </li>
        <li>
            <input type="text" value="Item" id="afterText" class="k-textbox"/>
            <button class="afterItem k-button">Insert After</button>
        </li>
    </ul>
</div>
