...
(function () {
    var o = window.kendo, e = o.dataviz.ui, r = o.deepExtend, l = 1.5, a = .4, c = "#000", i = "Arial,Helvetica,sans-serif", s = "11px " + i, f = "12px " + i, t = "16px " + i, n = "#fff", d = {
        title: {font: t},
        legend: {labels: {font: f}},
        seriesDefaults: {
            labels: {font: s},
            donut: {margin: 1},
            line: {width: 4},
            ...
            bar: {gap: l, spacing: a},
            column: {gap: l, spacing: a}
        },
        categoryAxis: {majorGridLines: {visible: !0}},
        axisDefaults: {labels: {font: f}, title: {font: t, margin: 5}},
        tooltip: {font: f},
        navigator: {pane: {height: 90, margin: {top: 10}}}
    }, b = {scale: {labels: {font: f}}}, g = e.themes, k = e.registerTheme = function (o, e) {
        var l = {};
        l.chart = r({}, d, e.chart), l.gauge = r({}, b, e.gauge);
        var a = l.chart.seriesDefaults;
        a.verticalLine = r({}, a.line), a.verticalArea = r({}, a.area), g[o] = l
    };
    k("black", {
        chart: {
            title: {color: n},
            legend: {labels: {color: n}},
            seriesDefaults: {
                labels: {color: n},
                ...
                candlestick: {
                    ...
                    highlight: {border: {color: n, opacity: .2}}
                },
                ohlc: {line: {color: n}}
            },
            ...
            tooltip: {background: "#3d3d3d", color: n, opacity: .8}
        },
        gauge: {
        ...
        chart: {
            ...
            seriesDefaults: {
                labels: {color: c, background: n, opacity: .5},
                area: {opacity: .4, markers: {visible: !1, size: 6}},
            ...
            tooltip: {background: n, color: c, opacity: .8}
        },
        gauge: {
        ...
        chart: {
            ...
            tooltip: {background: n, color: "#4e5968", opacity: .8}
        },
        gauge: {
