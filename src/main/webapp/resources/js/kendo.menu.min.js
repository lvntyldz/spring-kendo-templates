...
(function (e, t) {
    ...
    function o(t) {
        t = e(t), t.addClass("k-item").children(b).addClass(P), t.children("a").addClass(I).children(b).addClass(P), t.filter(":not([disabled])").addClass(z), t.filter(".k-separator:empty").append("&nbsp;"), t.filter("li[disabled]").addClass(B).removeAttr("disabled").attr("aria-disabled", !0), t.children("a").filter(":focus").parent().addClass(N), t.filter("[role]").length || t.attr("role", "menuitem"), t.children("." + I).length || t.contents().filter(function () {
            return !(this.nodeName.match(_) || 3 == this.nodeType && !e.trim(this.nodeValue))
        }).wrapAll("<span class='" + I + "'/>"), a(t), s(t)
    }
    ...
    function s(t) {
        t = e(t), t.filter(".k-first:not(:first-child)").removeClass(D), t.filter(".k-last:not(:last-child)").removeClass(H), t.filter(":first-child").addClass(D), t.filter(":last-child").addClass(H)
    }

    var l = window.kendo, d = l.ui, c = l.support.touch && l.support.mobileOS || l.support.pointers, p = l.support.mousedown, u = l.support.click, m = e.extend, h = e.proxy, f = e.each, g = l.template, v = l.keys, k = d.Widget, _ = /^(ul|a|div)$/i, C = ".kendoMenu", b = "img", w = "open", x = "k-menu", I = "k-link", H = "k-last", T = "close", y = "timer", D = "k-first", P = "k-image", A = "select", O = "zIndex", R = "mouseenter", U = "mouseleave", E = "kendoPopup", z = "k-state-default", S = "k-state-hover", L = "k-state-focused", B = "k-state-disabled", G = ".k-group", N = "k-state-active", W = ":not(.k-list) > .k-item", j = ".k-item.k-state-disabled", M = ".k-item:not(.k-state-disabled)", V = ".k-item:not(.k-state-disabled) > .k-link", Z = "div:not(.k-animation-container,.k-list-container)", $ = {
        ...
        init: function (t, n) {
            ...
            }).on(u + C, j, !1).on(u + C, M, h(i._click, i)).on("keydown" + C, h(i._keydown, i)).on("focus" + C, h(i._focus, i)).on("blur" + C, h(i._removeHoverItem, i)).on(R + C, M, h(i._mouseenter, i)).on(U + C, M, h(i._mouseleave, i)).on(R + C + " " + U + C + " " + p + C + " " + u + C, V, h(i._toggleHover, i)), n.openOnClick && (i.clicked = !1, i._documentClickHandler = h(i._documentClick, i), e(document).click(i._documentClickHandler)), t.attr("role", "menubar"), t[0].id && (i._ariaId = l.format("{0}_mn_active", t[0].id)), l.notify(i)
        },
        events: [w, T, A],
        options: {
            name: "Menu",
        ...
        destroy: function () {
            var t = this;
            k.fn.destroy.call(t), t.element.off(C), t._documentClickHandler && e(document).unbind(t._documentClickHandler)
        },
        enable: function (e, t) {
        ...
        append: function (t, n) {
            ...
            return f(i.items, function (t) {
                i.group.append(this);
                var n = i.contents[t];
                n && e(this).append(n), a(this)
            }), a(n), s(i.group.find(".k-first, .k-last").add(i.items)), this
        },
        insertBefore: function (t, n) {
            ...
            return f(i.items, function (t) {
                n.before(this);
                var r = i.contents[t];
                r && e(this).append(r), a(this), s(this)
            }), s(n), this
        },
        ...
        _insert: function (t, n, i) {
            ...
            return n && !i.length && (i = e(F.renderGroup({group: c})).appendTo(n)), d || e.isArray(t) ? (r = e.map(d ? [t] : t, function (t, n) {
                return "string" == typeof t ? e(t) : e(F.renderItem({group: c, item: m(t, {index: n})}))
            }), l = e.map(d ? [t] : t, function (t, n) {
                return t.content || t.contentUrl ? e(F.renderContent({item: m(t, {index: n})})) : !1
        ...
        remove: function (e) {
            ...
            var t = this, n = e.parentsUntil(t.element, W), i = e.parent("ul");
        ...
        open: function (r) {
            ...
            return r = o.element.find(r), /^(top|bottom|default)$/.test(d) && (d = c ? s ? (d + " left").replace("default", "bottom") : "left" : s ? (d + " right").replace("default", "bottom") : "right"), r.siblings().find(">.k-popup:visible,>.k-animation-container>.k-popup:visible").each(function () {
                ...
                var r = e(this);
                clearTimeout(r.data(y)), r.data(y, setTimeout(function () {
                    var e, l = r.find(".k-group:first:hidden");
                    if (l[0] && o.trigger(w, {item: r[0]}) === !1) {
                        r.data(O, r.css(O)), r.css(O, o.nextItemZIndex++), e = l.data(E);
                        var p = r.parent().hasClass(x), u = p && s, h = i(d, p, c), f = a.animation.open.effects, g = f !== t ? f : "slideIn:" + n(d, p);
                        e ? (e = l.data(E), e.options.origin = h.origin, e.options.position = h.position, e.options.animation.open.effects = g) : e = l.kendoPopup({
                            origin: h.origin,
                            position: h.position,
                            collision: a.popupCollision !== t ? a.popupCollision : u ? "fit" : "fit flip",
                            anchor: r,
                            appendTo: r,
                            animation: {open: m(!0, {effects: g}, a.animation.open), close: a.animation.close},
                            close: function (e) {
                                var t = e.sender.wrapper.parent();
                                o.trigger(T, {item: t[0]}) ? e.preventDefault() : (t.css(O, t.data(O)), t.removeData(O))
                            }
                        }).data(E), l.removeAttr("aria-hidden"), e.open()
                    }
        ...
        close: function (t) {
            ...
            return t = i.find(t), t.length || (t = i.find(">.k-item")), t.each(function () {
                var t = e(this);
                clearTimeout(t.data(y)), t.data(y, setTimeout(function () {
                    var e = t.find(".k-group:first:visible").data(E);
        ...
        _toggleDisabled: function (t, n) {
            this.element.find(t).each(function () {
                e(this).toggleClass(z, n).toggleClass(B, !n).attr("aria-disabled", !n)
            })
        },
        _toggleHover: function (t) {
            var n = e(l.eventTarget(t) || t.target).closest(W), i = t.type == R || -1 !== p.indexOf(t.type);
            n.parents("li." + B).length || n.toggleClass(S, i), this._removeHoverItem()
        },
        _removeHoverItem: function () {
            var e = this._oldHoverItem;
            e && e.hasClass(L) && (e.removeClass(L), this._oldHoverItem = null)
        },
        ...
        _mouseenter: function (t) {
            var n = this, i = e(t.currentTarget), o = i.children(".k-animation-container").length || i.children(G).length;
            t.delegateTarget == i.parents(".k-menu")[0] && ((!n.options.openOnClick || n.clicked) && !r(t.currentTarget, t.relatedTarget) && o && n.open(i), (n.options.openOnClick && n.clicked || c) && i.siblings().each(h(function (e, t) {
                n.close(t)
            }, n)))
        },
        _mouseleave: function (n) {
            var i = this, o = e(n.currentTarget), a = o.children(".k-animation-container").length || o.children(G).length;
            return o.parentsUntil(".k-animation-container", ".k-list-container,.k-calendar-container")[0] ? (n.stopImmediatePropagation(), t) : (i.options.openOnClick || c || r(n.currentTarget, n.relatedTarget) || !a || i.close(o), t)
        },
        _click: function (n) {
            var i, r, o, a = this, s = a.options, d = e(l.eventTarget(n)), c = d[0] ? d[0].nodeName.toUpperCase() : "", p = "INPUT" == c || "SELECT" == c || "BUTTON" == c, u = d.closest("." + I), m = d.closest(W), h = u.attr("href"), f = !!h && "#" != h.charAt(h.length - 1);
            if (!m.children(Z)[0])return m.hasClass(B) ? (n.preventDefault(), t) : (n.handled || !a.trigger(A, {item: m[0]}) || p || n.preventDefault(), n.handled = !0, r = m.children(G + ",.k-animation-container"), o = r.is(":visible"), s.closeOnClick && !f && (!r.length || s.openOnClick && o) ? (m.removeClass(S).css("height"), a._oldHoverItem = a._findRootParent(m), a.close(u.parentsUntil(a.element, W)), a.clicked = !1, -1 != "touchend MSPointerUp".indexOf(n.type) && n.preventDefault(), t) : ((m.parent().hasClass(x) && s.openOnClick || l.support.touch) && (f || p || n.preventDefault(), a.clicked = !0, i = r.is(":visible") ? T : w, a[i](m)), t))
        },
        ...
        _keydown: function (e) {
            ...
            if (e.target == e.currentTarget || a == v.ESC) {
                if (s || (s = o._oldHoverItem = o._hoverItem()), i = o._itemBelongsToVertival(s), r = o._itemHasChildren(s), a == v.RIGHT)n = o[d ? "_itemLeft" : "_itemRight"](s, i, r); else if (a == v.LEFT)n = o[d ? "_itemRight" : "_itemLeft"](s, i, r); else if (a == v.DOWN)n = o._itemDown(s, i, r); else if (a == v.UP)n = o._itemUp(s, i, r); else if (a == v.ESC)n = o._itemEsc(s, i); else if (a == v.ENTER || a == v.SPACEBAR)n = s.children(".k-link"), n.length > 0 && (o._click({
                    target: n[0],
                    preventDefault: function () {
                    }
                }), o._moveHover(s, o._findRootParent(s))); else if (a == v.TAB)return n = o._findRootParent(s), o.close(n), o._moveHover(s, n), t;
        ...
        _moveHover: function (e, t) {
            ...
            e.length && t.length && (e.removeClass(L), e[0].id === i && e.removeAttr("id")), t.length && (t[0].id && (i = t[0].id), t.addClass(L), n._oldHoverItem = t, i && (n.element.removeAttr("aria-activedescendant"), t.attr("id", i), n.element.attr("aria-activedescendant", i)))
        },
        ...
        _itemRight: function (e, t, n) {
            var i, r, o = this;
            return t ? n ? (o.open(e), i = e.find(".k-group").children().first()) : "horizontal" == o.options.orientation && (r = o._findRootParent(e), o.close(r), i = r.next(), i.is(".k-separator") && (i = i.next())) : (i = e.next(), i.is(".k-separator") && (i = i.next()), i.length || (i = e.parent().children().first())), i && !i.length ? i = o.wrapper.children(".k-item").first() : i || (i = []), o._moveHover(e, i), i
        },
    ...
    m(F, {
        renderItem: function (e) {
            ...
            return $.item(m(e, {
                ...
                subGroup: F.renderGroup
            }, q))
        }, renderGroup: function (e) {
            return $.group(m({
                renderItems: function (e) {
                    for (var t = "", n = 0, i = e.items, r = i ? i.length : 0, o = m({length: r}, e.group); r > n; n++)t += F.renderItem(m(e, {
                        group: o,
                        item: m({index: n}, i[n])
                    }));
                    return t
