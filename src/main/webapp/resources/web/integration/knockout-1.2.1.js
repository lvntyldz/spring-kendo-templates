...
(function (window, undefined) {
    ...
    p.a = new function () {
        ...
        return {
            ca: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], g: function (a, b) {
        ...
        p.c.template = {
            update: function (b, a, d, e) {
                ...
                if (typeof a.foreach != "undefined")e = p.Wa(d, a.foreach || [],
                    ...
                    }, b); else var g = a.data, e = p.X(d, typeof g == "undefined" ? e : g, {
                    templateOptions: a.templateOptions,
                    afterRender: a.afterRender
                }, b);
            ...
            if (g === m)h = o; else {
                for (; b > 0 || a > 0;) {
                    ...
                    k <= j && k < l ? (f.push({
                        ...
                        status: "deleted",
                        value: e[b - 1]
                    }) : (f.push({status: "retained", value: e[b - 1]}), a--), b--)
                }
                h = f.reverse()
            }
            return h
